...
class AddRecordForm(forms.ModelForm):
    first_name= forms.CharField(required=False, widget=forms.widgets.TextInput(attrs={'placeholder':'first_name', "class":'form-control'}), label="")
    last_name= forms.CharField(required=False, widget=forms.widgets.TextInput(attrs={'placeholder':'last_name', "class":'form-control'}), label="")
